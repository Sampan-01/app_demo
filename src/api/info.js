...
// 车型管理+搜索
export const fetchVehicle = data => fetchApi('vehicle/search', data)
// 车型管理 + 新增
export const fetchVehicleAdd = data => fetchApi('vehivle/insert', data, 'POST')

// 车规管理 + 搜索
export const fetchGaugeList = data => fetchApi('gauge/search', data)
// 车规管理 + 删除
export const fetchGaugeDel = data => fetchApi('gauge/delete', data, 'POST')
// 车规管理+修改（新增不用加id）
